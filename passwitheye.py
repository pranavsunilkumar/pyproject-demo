...
# Entry with toggle beside it (horizontal)
entry_frame = tk.Frame(frame, bg="#dbeafe")
entry_frame.pack()

entry = tk.Entry(entry_frame, show="*", width=26, font=("Helvetica", 12), bd=2, relief="solid")
entry.pack(side="left", padx=(0, 5))

toggle_btn = tk.Button(entry_frame, text='👁️', command=toggle_password_visibility, font=("Helvetica", 12), bd=0, bg="#dbeafe", activebackground="#dbeafe")
